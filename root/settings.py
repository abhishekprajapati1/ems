...
SECRET_KEY = 'django-insecure-6nvr5+tff@5h8i*q$wsj2kn(t^w8z^)&sy21&a1^c56h+4&wa@'
...
AUTHENTICATION_BACKENDS = [
    'authentication.backends.EmailPasswordBackend',  # Use the custom backend
    'django.contrib.auth.backends.ModelBackend',  # Include the default backend for fallback
]
